;(function () {
	...
	var previewJSON = $('.toolbar #previewJSON', window.parent.document);
	if (!previewJSON.length) {
		$('.toolbar', window.parent.document).append('<i id="previewJSON" title="查看 profile" class="fas fa-database ui-corner-all ui-state-default"></i>')
		$('.toolbar #previewJSON', window.parent.document).click(function () {
